...
public class Overzicht_Studenten1G extends ActionBarActivity {
    ...
    private void displayListView(){
        Cursor cursor = dbHelper.SelecteerStudenten1G();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_overzicht__studenten1_g, menu);
        return true;
    }
