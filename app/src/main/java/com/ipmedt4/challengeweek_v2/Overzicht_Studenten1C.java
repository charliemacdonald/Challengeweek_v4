...
public class Overzicht_Studenten1C extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_overzicht__studenten1c);
    ...
    private void displayListView(){
        Cursor cursor = dbHelper.SelecteerStudenten1C();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_overzicht__studenten1_c, menu);
        return true;
    }
