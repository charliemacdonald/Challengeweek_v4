...
public class Overzicht_Studenten1A extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_overzicht__studenten1a);
    ...
    private void displayListView(){
        Cursor cursor = dbHelper.SelecteerStudenten1A();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_overzicht__studenten1, menu);
        return true;
    }
