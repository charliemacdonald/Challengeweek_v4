...
public class Overzicht_Studenten1E extends ActionBarActivity {
    ...
    private void displayListView(){
        Cursor cursor = dbHelper.SelecteerStudenten1E();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_overzicht__studenten1_e, menu);
        return true;
    }
