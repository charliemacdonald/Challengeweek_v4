...
public class Overzicht_Studenten1H extends ListActivity {
    ...
    // URL to get contacts JSON
    private static String url = "http://charlenemacdonald.com/getStudenten1H.php";
    ...
    private class GetStudenten extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Overzicht_Studenten1H.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    Overzicht_Studenten1H.this, studentList,
