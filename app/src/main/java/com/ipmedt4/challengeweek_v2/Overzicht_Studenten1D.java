...
public class Overzicht_Studenten1D extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_overzicht__studenten1d);
    ...
    private void displayListView(){
        Cursor cursor = dbHelper.SelecteerStudenten1D();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_overzicht__studenten1_d, menu);
        return true;
    }
