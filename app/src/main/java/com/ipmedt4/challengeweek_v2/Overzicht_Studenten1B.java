...
public class Overzicht_Studenten1B extends ListActivity {
    ...
    // URL to get contacts JSON
    private static String url = "http://charlenemacdonald.com/getStudenten1B.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_overzicht__studenten1b);
    ...
    private class GetStudenten extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Overzicht_Studenten1B.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    Overzicht_Studenten1B.this, studentList,
