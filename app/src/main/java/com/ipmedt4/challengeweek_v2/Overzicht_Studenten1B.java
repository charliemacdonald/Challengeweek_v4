...
public class Overzicht_Studenten1B extends ActionBarActivity {
    ...
    private void displayListView(){
        Cursor cursor = dbHelper.SelecteerStudenten1B();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_selecteer__studenten1_b, menu);
        return true;
    }
